...
The standard deviation for years with the company is ~`r round(sd(ceo.df$comten), 1)`, which is large but unsuprising given the variablity of the dataset.
```{r}
sd(ceo.df$comten)
```
...
```{r}
hist(ceo.df$mktval,main="Market Value at the End of 1990",xlab = "millions",breaks = 100)
